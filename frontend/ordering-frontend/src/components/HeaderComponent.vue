<template>
    <nav class="navbar navbar-expand-lg custom-pink-navbar">
        <!-- ADMIN이 볼 수 있는 메뉴 -->
        ...
        <div class="mx-auto order-0">
            <a class="navbar-brand mx-auto" href="/">Shop At Hong</a>
        </div>
...
.custom-pink-navbar .nav-link,
.custom-pink-navbar .navbar-brand {
  color: #000 !important;
  font-weight: 500;
}

.custom-pink-navbar .nav-link:hover {
  color: #333 !important; 
}
</style>